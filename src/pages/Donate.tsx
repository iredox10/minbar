...
import { Heart, CreditCard, ExternalLink, Building2, Copy, CheckCircle2 } from 'lucide-react';
  ...
  const donationLinks = [
    {
      ...
      icon: CreditCard,
      url: 'https://paystack.com/pay/your-link', // TODO: Update with actual Paystack link
      color: 'bg-[#092E20]',
    ...
    },
    {
      ...
      icon: CreditCard,
      url: 'https://flutterwave.com/pay/your-link', // TODO: Update with actual Flutterwave link
      color: 'bg-[#FB9129]',
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="space-y-4 relative">
              <div>
                ...
                <p className="text-slate-200 font-medium">Guaranty Trust Bank (GTB)</p>
              </div>
              
              <div>
                <p className="text-xs font-medium text-slate-500 uppercase tracking-wider mb-1">Account Name</p>
                <p className="text-slate-200 font-medium">Arewa Central</p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between bg-slate-900/50 rounded-xl p-3 border border-slate-700">
                  <span className="text-xl font-mono text-emerald-400 tracking-wider">0123456789</span>
                  <button 
